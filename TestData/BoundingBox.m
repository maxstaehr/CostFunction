classdef BoundingBox
    ...
    methods
        ...
        patch(p1(:,1), p1(:,2), p1(:,3),c);
        alpha(0.25);
        patch(p2(:,1), p2(:,2), p2(:,3),c);
        alpha(0.25);
        patch(p3(:,1), p3(:,2), p3(:,3),c);
        alpha(0.25);
        patch(p4(:,1), p4(:,2), p4(:,3),c);
        alpha(0.25);
        patch(p5(:,1), p5(:,2), p5(:,3),c);
         alpha(0.25);
        patch(p6(:,1), p6(:,2), p6(:,3),c);
         alpha(0.25);
        end
